    ...
    public String getTrans(){
        ...
        if (dataTable.Rows.Count > 0)
        {
            for (int i = 0; i < dataTable.Rows.Count; i++)
            {
                ...
                core.accepted_o = Convert.ToBool(dataTable.Rows[i]["accepted_o"]);
                core.accepted_k = Convert.ToBool(dataTable.Rows[i]["accepted_k"]);
                core.paid_in_cash = Convert.ToBool(dataTable.Rows[i]["paid_in_cash"]);
